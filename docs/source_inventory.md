...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Source name** | customers.csv | orders.json | products.parquet | REST API | inventory_snapshot |
...
| **Possible primary/business key** | customer_id | order_id | product_id | *Pending API Inspection* | *Pending DB Inspection* |
